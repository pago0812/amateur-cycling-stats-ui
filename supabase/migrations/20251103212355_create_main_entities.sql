...
COMMENT ON COLUMN public.events.created_by IS 'User who created the event (organizer)';
...
-- =====================================================
-- EVENT SUPPORTED CATEGORIES (Many-to-Many Junction Tables)
-- =====================================================
...
-- =====================================================
-- AUTO-CREATE CYCLIST PROFILE ON USER SIGNUP
-- =====================================================
-- Function to create cyclist profile when user signs up with CYCLIST role
...
BEGIN
    ...
    IF NEW.role_id = cyclist_role_id THEN
        ...
        -- Create minimal cyclist profile
...
-- Trigger to call handle_new_cyclist_user() when a new user profile is created
