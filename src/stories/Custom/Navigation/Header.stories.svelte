				...
				<table class="min-w-full divide-y divide-border">
					...
					<tbody class="divide-y divide-border bg-card">
						...
						<tr>
							...
							<td class="px-4 py-3 font-mono text-sm">/panel</td>
						...
						<tr>
							...
							<td class="px-4 py-3 font-mono text-sm">/account</td>
