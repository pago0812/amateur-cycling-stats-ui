	...
	<div class="mx-auto max-w-6xl p-8">
		<div class="mb-12">
			...
			>
				...
				<code class="rounded bg-amber-100 px-1.5 py-0.5 dark:bg-amber-900/40">$page</code> store for
				active tab detection, which cannot be fully mocked in Storybook. Tab highlighting may not work
				as expected.
			</div>
		</div>
		...
		<section class="mb-12">
			...
			<div class="space-y-6">
				<div>
					...
					<MenuToolbar breadcrumbs={[{ label: 'Panel', href: '/panel' }, { label: 'Dashboard' }]} />
				</div>
			...
			<div class="overflow-x-auto rounded-lg border border-border">
				<table class="min-w-full divide-y divide-border">
					...
					<tbody class="divide-y divide-border bg-card">
						<tr>
							<td class="px-4 py-3 font-mono text-sm">/panel/organization</td>
							<td class="px-4 py-3 text-sm">Overview</td>
							<td class="px-4 py-3 text-sm text-muted-foreground">Exact match</td>
						</tr>
						<tr>
							<td class="px-4 py-3 font-mono text-sm">/panel/organization/members</td>
							<td class="px-4 py-3 text-sm">Members</td>
							<td class="px-4 py-3 text-sm text-muted-foreground">Exact match</td>
						</tr>
						<tr>
							<td class="px-4 py-3 font-mono text-sm">/panel/organization/members/123</td>
							<td class="px-4 py-3 text-sm">Members</td>
...
&lt;!-- Full example --&gt;
&lt;MenuToolbar &#123;breadcrumbs&#125; &#123;tabs&#125; &#123;actions&#125; /&gt;</code
					></pre>
			</div>
		</section>
	</div>
