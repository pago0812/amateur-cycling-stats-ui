...
<div class="mx-auto max-w-6xl p-8">
	...
	<section class="mb-12">
		...
		<ul class="list-disc space-y-2 pl-6 text-muted-foreground">
			...
			<li>Progressive enhancement with <code class="rounded bg-muted px-1.5 py-0.5">use:enhance</code></li>
			<li>Bindable form element reference via <code class="rounded bg-muted px-1.5 py-0.5">formElement</code></li>
			<li>Loading state support with <code class="rounded bg-muted px-1.5 py-0.5">isSubmitting</code></li>
			<li>Form validation (HTML5 required, minlength, maxlength)</li>
			<li>Internationalization support</li>
			<li>Pre-filled values support via <code class="rounded bg-muted px-1.5 py-0.5">initialData</code> and <code class="rounded bg-muted px-1.5 py-0.5">form</code></li>
		</ul>
	</section>
