...
<script lang="ts">
	import { mockCyclist, mockCyclist2, mockRaceResults, generateMockRaceResults } from '../../mocks';
	...
	<div class="mx-auto max-w-6xl p-8">
		<div class="mb-12">
			...
			<p class="text-lg text-muted-foreground">
				Displays cyclist information and race history. Shows personal details with profile avatar
				and a comprehensive table of race results.
			</p>
		</div>
...
&lt;CyclistProfile &#123;cyclist&#125; &#123;raceResults&#125; /&gt;</code
					></pre>
			</div>
		</section>
	</div>
