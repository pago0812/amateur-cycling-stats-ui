	...
	<section class="mb-12">
		...
		<div class="grid gap-4 md:grid-cols-3">
			...
			<div class="rounded-lg border border-border bg-card p-6">
				...
				<p class="mt-3 text-xs text-muted-foreground">
					Pending owner invitation acceptance
				</p>
			</div>
			<div class="rounded-lg border border-border bg-card p-6">
				<h3 class="mb-3 text-sm font-medium text-muted-foreground">Disabled State</h3>
				<span class="inline-flex items-center rounded-full bg-muted px-3 py-1 text-sm font-medium text-muted-foreground">
					Disabled
				</span>
				<p class="mt-3 text-xs text-muted-foreground">
					Organization is inactive or soft-deleted
				</p>
			</div>
		</div>
	</section>
			...
			<table class="min-w-full divide-y divide-border">
				...
				<tbody class="divide-y divide-border bg-card">
					...
					<tr>
						...
						<td class="px-4 py-3 text-sm text-muted-foreground"
							>Creation timestamp (formatted)</td
						>
						<td class="px-4 py-3 text-sm">Yes</td>
					</tr>
					<tr>
...
&lt;OrganizationProfile &#123;organization&#125; /&gt;</code></pre>
		</div>
	</section>
</div>
