...
<div class="mx-auto max-w-6xl p-8">
	<div class="mb-12">
		...
		<div class="mt-4 rounded-lg bg-amber-50 p-4 text-sm text-amber-900 dark:bg-amber-950/20 dark:text-amber-200">
			<strong>Note:</strong> This component uses <code class="rounded bg-amber-100 px-1.5 py-0.5 dark:bg-amber-900/40">$page</code> store from
			<code class="rounded bg-amber-100 px-1.5 py-0.5 dark:bg-amber-900/40">$app/stores</code> which cannot be fully mocked in Storybook. The examples below
...
&lt;!-- Changing value updates URL and triggers SSR reload --&gt;</code></pre>
		</div>
	</section>
</div>
