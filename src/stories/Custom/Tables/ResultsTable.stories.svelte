				...
				<table class="min-w-full divide-y divide-border">
					...
					<tbody class="divide-y divide-border bg-card">
						...
						<tr>
							...
							>
							<td class="px-4 py-3 font-mono text-sm">First Last (link)</td>
						</tr>
						<tr>
							<td class="px-4 py-3 text-sm font-medium">Time</td>
							<td class="px-4 py-3 text-sm text-muted-foreground">Race time (shows "-" if null)</td>
							<td class="px-4 py-3 font-mono text-sm">HH:MM:SS</td>
						</tr>
						<tr>
