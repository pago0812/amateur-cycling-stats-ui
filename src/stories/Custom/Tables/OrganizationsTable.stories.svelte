			...
			<table class="min-w-full divide-y divide-border">
				<thead class="bg-muted/50">
					<tr>
						...
						<th class="px-4 py-3 text-left text-xs font-medium text-muted-foreground">Tablet (sm)</th>
						<th class="px-4 py-3 text-left text-xs font-medium text-muted-foreground">Desktop (md)</th>
						<th class="px-4 py-3 text-left text-xs font-medium text-muted-foreground">Large (lg)</th>
					</tr>
				</thead>
...
&lt;OrganizationsTable &#123;organizations&#125; /&gt;</code></pre>
		</div>
	</section>
</div>
