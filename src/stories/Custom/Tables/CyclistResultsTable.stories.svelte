				...
				<table class="min-w-full divide-y divide-border">
					...
					<tbody class="divide-y divide-border bg-card">
						...
						<tr>
							...
							<td class="px-4 py-3 font-mono text-sm">Text with link</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="px-4 py-3 font-mono text-sm">100, 80, 60...</td>
						</tr>
					</tbody>
				</table>
			</div>
...
&lt;CyclistResultsTable &#123;raceResults&#125; /&gt;</code
					></pre>
			</div>
		</section>
	</div>
