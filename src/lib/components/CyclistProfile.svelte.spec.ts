...
describe('CyclistProfile Component', () => {
	...
	it('should render cyclist name', async () => {
		render(CyclistProfile, { cyclist: mockCyclist, raceResults: mockRaceResults });
	...
	it('should show no results message when cyclist has no race results', async () => {
		render(CyclistProfile, { cyclist: mockCyclist, raceResults: [] });
	...
	it('should not render born year section when null', async () => {
		const cyclistWithoutYear: Cyclist = {
			...mockCyclist,
			bornYear: null
		};

		render(CyclistProfile, { cyclist: cyclistWithoutYear, raceResults: mockRaceResults });
