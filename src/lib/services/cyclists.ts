...
import type { CyclistOld, CyclistWithRelations } from '$lib/types/domain';
 ...
 * Returns domain CyclistOld type with camelCase fields.
 *
 ...
 *
 * @deprecated This uses old Cyclist domain type. Will be refactored in future to use new flattened types.
 */
